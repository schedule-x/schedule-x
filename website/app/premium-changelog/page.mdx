...
* **resource-scheduler:** dark mode

## 15.3.0 (2026-02-20)

### Features

* **sidebar:** reactively setting active calendars
...
* build error
* **drag-and-drop:** transition position

### Features

* **interactive-event-modal:** readonly calendars
* **time-grid-resource-view:** dragging

## 15.1.1 (2026-01-21)

### Bug Fixes

* event propagation in resource time grid event
...
* **sidebar:** custom components for placeholder events
* **time-grid-resource-view:** event drawing
* **time-grid-resource-view:** event modal
* **time-grid-resource-view:** event resizing
...
* **resource-scheduler:** move resource config to main calendar config
...
* **resource-scheduler:** add dayNameFormat API

### BREAKING CHANGES

* **resource-scheduler:** setting dayNameFormat to short and highlightToday to true by default

## 13.3.0 (2025-12-06)

### Features

* **resource-scheduler:** add highlightToday config option
* **resource-scheduler:** lazy load with debounce
...
* resource column visibility with many resources

## 13.2.0 (2025-11-04)

### Features

* add day boundaries config in hourly view
...
* styles in resource view header
...
* rangeError
* rangeError in dragging
* tz missing in resize handler


### Features

* temporal api
* use PlainDateTime for initialHours
