...
<Tabs items={['npm', 'pnpm', 'yarn']}>
  <Tabs.Tab>
    ```bash copy
      npm install @schedule-x/angular @schedule-x/calendar @schedule-x/theme-default temporal-polyfill
    ```
  </Tabs.Tab>

  <Tabs.Tab>
    ```bash copy
      pnpm install @schedule-x/angular @schedule-x/calendar @schedule-x/theme-default @preact/signals preact temporal-polyfill
    ```
  </Tabs.Tab>

  <Tabs.Tab>
    ```bash copy
      yarn add @schedule-x/angular @schedule-x/calendar @schedule-x/theme-default @preact/signals preact temporal-polyfill
    ```
  </Tabs.Tab>
</Tabs>
    ...
    events: [
      {
        id: '1',
        title: 'Event 1',
        start: Temporal.ZonedDateTime.from('2024-06-11T03:00:00+09:00[Asia/Tokyo]'),
        end: Temporal.ZonedDateTime.from('2024-06-11T05:00:00+09:00[Asia/Tokyo]'),
      },
    ],
