...
<Callout type="warning">
  The Angular component is not yet migrated to v3 & Temporal API.

  If you want to use the Temporal API with SX and Angular already, you can use the [vanilla JS component](/docs/calendar), or help us migrate the Angular component to v3.
</Callout>
