...
<Callout type="info">
  This is a premium feature which requires an active license to be used. Learn more at [Schedule-X premium](https://schedule-x.dev/premium).
</Callout>
...
[Go to Demo](https://schedule-x.dev/demos/resource-scheduler)
