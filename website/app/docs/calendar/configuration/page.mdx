...
const config = {
  ...
  monthGridOptions: {
    ...
    /**
     * Optional comparator for ordering events within each day cell.
     * When omitted, events use the default month-grid sorting.
     * */
    sortEvents: (a, b) =>
  ...
  monthAgendaOptions: {
    /**
     * Number of event indicators to display in a day cell.
     * */
    nEventIndicatorsPerDay: 3,

    /**
     * Optional comparator for ordering the selected day's events.
     * When omitted, events are sorted by their start and end times.
     * */
