...
1) Lifetime License: One-time payment per team, includes 1 year of software updates and support. Continued access to updates and support after this period requires an additional support contract.
...
Licenses are sold on a per-project basis. The price depends on the total number of software developers in your organization or project team where Schedule-X Premium is being used.
