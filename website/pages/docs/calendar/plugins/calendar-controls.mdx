...
Set the available views for the calendar. The views to be set must include the currently active view name.
...
Set whether the calendar is in dark mode or not.
...
Get the current default view of the calendar.
...
Get whether the calendar is configured in dark mode or not.
