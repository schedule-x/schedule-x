...
>
  <source
    src={
      'https://d19hgxvhjb2new.cloudfront.net/website/interactive-modal-demo.mp4'
    }
    type={'video/mp4'}
  />
</video>
...
const eventModal = createInteractiveEventModal({
  ...
  customFields: {
    additionalNotes: {
      // will correspond to an event property "additionalNotes"
    ...
    locationSelect: {
      // will correspond to an event property "locationSelect"
      label: 'Location',
      type: 'select',
      items: [
