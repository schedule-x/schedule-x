...
<Cards num={2}>
  <Cards.Card arrow title="React" href="/docs/frameworks/react"></Cards.Card>
  <Cards.Card arrow title="Vue" href="/docs/frameworks/vue"></Cards.Card>
</Cards>
...
<Cards num={3}>
  ...
  ></Cards.Card>
  <Cards.Card arrow title="Svelte" href="/docs/frameworks/svelte"></Cards.Card>
  <Cards.Card arrow title="Preact" href="/docs/frameworks/preact"></Cards.Card>
</Cards>
...
1. A list of views. Currently available views are **month grid**,
   **week**, **day** and **month agenda**.
2. A list of events.
...
<html class="no-js" lang="">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/@schedule-x/theme-default@2.2.0/dist/index.css"
    />
  </head>
  ...
  <body>
    ...
    <script type="module">
      ...
      const plugins = [createDragAndDropPlugin()]
