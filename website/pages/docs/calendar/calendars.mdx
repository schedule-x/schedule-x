...
The events of a single calendar can be sorted into different categories, called calendars. For example, this can be
useful if you want to display a calendar each for a specific team, department or school class, all in one user
interface. The calenders can then be distinguished by their color.
