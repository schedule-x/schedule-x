...
Resize events by dragging the bottom edge of the event.

import {Callout} from "nextra/components";

<Callout type="info" emoji="💡" title="Note">
  This plugin currently only offers resizing in the week- and day views. Month view support is planned as a minor
  release during the 1.x.x release cycle.
</Callout>
