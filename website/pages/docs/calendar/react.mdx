...
<Callout>
  There is a known issue (reported on 4th of January) with using the React component in Next.js. While this is being
  fixed, you can use the `createCalendar` function to create a calendar instance in your Next.js project. Usage of
  this function is documented under the [getting started page](https://schedule-x.dev/docs/calendar). Switching to the
  React component later on, will only be a matter of a few lines of code.
</Callout>
