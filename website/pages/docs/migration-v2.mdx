...
The premium plugins are trailing one major version behind. When updating to v2, make sure to update your premium plugins to
the latest version as well (1.X.X).
