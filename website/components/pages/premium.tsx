      ...
      <div className={'premiumPage page-wrapper'}>
        <section className={'premiumPage__heroAndDemo'}>
          ...
          <h2 className={'heroSubHeading'}>
            Don't waste time building stuff like forms, calendar toggles, or
            drag-to-create. Someone already built all that for you.
          </h2>
        ...
        >
          ...
          <div className={'premiumPageCards'}>
            ...
            <SalesCard
              ...
              buttonLink={
                'https://docs.google.com/forms/d/e/1FAIpQLSfE0G6RCUbnzbEUCMGEKcfUGx6XprAPU_IGRxNZ2UajizU7SA/viewform?usp=sf_link'
              }
              buttonClass={'black'}
            />
          </div>
        ...
        <section className={'faq'}>
          ...
          <Accordion style={{ width: '100%', maxWidth: '950px' }}>
            <Accordion.Panel
              header="Can I use the license commercially?"
              defaultExpanded
            >
              <i>Yes, you can.</i> Though I plan to introduce an OEM license
              later, I believe in honoring those who believed in the project
              early on. You can continue using Schedule-X premium commercially
              without having to upgrade licenses later on, if you buy it before
              OEM licensing is introduced.
            </Accordion.Panel>
            <Accordion.Panel header="How many issues and feature requests are included?">
              There is no limit to how many issues and feature requests you can
              submit. However, you buy the software <i>as is</i>, without any
              guarantee that I will build features that you request. If I
              believe that a feature is useful to many customers, I am more
              likely to build it.
              <br />
              <br />
              If you want certainty that a feature will be built, you need to
              select an enterprise license so we can discuss the terms of the
              feature request.
            </Accordion.Panel>
            <Accordion.Panel header="Can I cache the software on my servers?">
              Yes. This is even encouraged. For example, you can use software
              like{' '}
              <a
              ...
              or JFrog artifactory. However,
              <strong>
                {' '}
                this does not mean that you are allowed to use Schedule-X
                premium beyond the terms of the license you purchased.
              </strong>{' '}
              You need to pay the yearly subscription, for as long as the
