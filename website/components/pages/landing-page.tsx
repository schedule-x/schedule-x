  ...
  return (
    <>
      <div className={'landingPage page-wrapper'}>
        <h1>
          <span className={'headingGradient'}>The modern</span> JavaScript event
          calendar
        </h1>

        <h2>
          Ship an event calendar with ease, regardless of tech-stack. Modern
        ...
        <section className={'landingPageSection'}>
          ...
          <div className={'features-heading'}>
            <AppReveal width={'fit-content'}>
              <div className="featuresText">For web devs</div>

              <h3>Ship a calendar in no time</h3>

              <p>
                Getting it right when building a calendar takes time. Schedule-X
                already has a lot of things figured out for you, so you can save
                yourself the months it would take to build a calendar from
                scratch.
              </p>
            </AppReveal>
          </div>
          ...
          <div className={'landingPageCards'}>
            ...
            <Card
              ...
              description={'Resize events by dragging the edges.'}
            />
          </div>
          ...
          <div className={'landingPageCards'}>
            ...
            <Card
              ...
              title={'Responsive'}
              description={'Works on all devices, from desktop to mobile'}
            />
          </div>
        </section>
        ...
        <section className={'landingPageSection hasMarginBottom'}>
          ...
          <div className={'features-heading'}>
            <AppReveal width={'fit-content'}>
              <div className="featuresText">The all-inclusive way</div>

              <h3>Schedule-X Premium</h3>

              <p>
                Someone already took care of the complex details you need for an
                all-inclusive calendar experience. No need to build it yourself.
              </p>
            </AppReveal>
            ...
            <Link href={'/premium'}>
              <button
                className={'landingPageAction buttonPrimary hasMarginBottom'}
              >
                Get premium →
              </button>
            </Link>
