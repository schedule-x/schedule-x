export default function AngularIcon() {
  return <>
    <svg style={{ display: 'inline', position: 'relative', top: '-3px', marginRight: '5px' }} width={40} _ngcontent-ng-c249881476="" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 223 236"
         class="angular-logo">
