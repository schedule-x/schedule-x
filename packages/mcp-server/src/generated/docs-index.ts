...
export const docsIndex: DocsIndex = {
  ...
  "docs": [
    {
      ...
      "content": "MCP server The Schedule-X MCP server gives AI coding tools access to a generated snapshot of the Schedule-X docs, plugin guidance, starter code and basic validation tools. Install Use the server through npx in any MCP client that supports local stdio servers: Tools Tool Purpose ---------------------------- ---------------------------------------------------------------- search docs Search the generated Schedule-X docs index. get doc Read one docs entry by id. list plugins List known plugins, package names, docs URLs and premium flags. get plugin setup Get install and docs guidance for one plugin. get starter Generate starter install commands and code. validate event Check event objects for common Schedule-X mistakes. validate calendar config Check calendar config objects for common setup mistakes. explain temporal usage Explain when to use Temporal.PlainDate or Temporal.ZonedDateTime ."
    },
    {
      "id": "calendar",
    ...
    },
    {
      ...
      "sourcePath": "website/app/docs/calendar/advanced/background-events/page.mdx",
      "section": "calendar",
      "headings": [
        "Background events",
        "API",
    ...
    },
    {
      ...
      "codeBlocks": [],
      "content": "Custom views The Schedule-X calendar can be extended endlessly. You are not limited to using the default views offered by this library; you can create your own views and plug them into the calendar. Currently, you can only build a custom view using Preact, the virtual DOM library used by Schedule-X, but the ambition is to extend this to enable building custom views in React and Vue. Building a custom view with Preact The easiest way to get started building a custom view is to clone the extension builder repo."
    },
    {
      ...
      "content": "Calendars The events of a single calendar can be sorted into different categories, called calendars. Configuration Each calendar needs a name, which is then referenced as calendarId in the events. The name can be freely chosen, as long as it can be used a JavaScript object key as in the example below, where we have the calendars personal , work , leisure and school . The value of colorName can only contain lower key characters, since this will internally be used as part of a custom CSS property. You do not need to define colors for dark- and light mode unless you use them both. Example"
    },
    {
    ...
    },
    {
      ...
      "codeBlocks": [
        {
          "language": "text",
          "content": "@sx-premium:registry=https://gitlab.schedule-x.com/api/v4/packages/npm/\n//gitlab.schedule-x.com/api/v4/packages/npm/:_authToken=${SX_PREMIUM_TOKEN}"
        },
        {
          "language": "bash",
    ...
    },
    {
      ...
      "codeBlocks": [
        {
          "language": "ts",
          "content": "const modal = createInteractiveEventModal({\n  fields: {\n    rruleFrequency: {},\n    rruleUntil: {}\n  }\n\n  // other config\n})"
        },
        {
          "language": "ts",
          "content": "const modal = createInteractiveEventModal({\n  fields: {\n    // your other fields\n    ...rruleFields()\n  }\n\n  // other config\n})"
    ...
    },
    {
      ...
      "content": "Plugins The calendar can be extended with additional features through plugins. The library offers a range of plugins that can be downloaded separately. You can also write your own custom plugins. Basic example You can add plugins to the calendar, by adding them to the config object. Available plugins"
    },
    {
      ...
      "sourcePath": "website/app/docs/calendar/plugins/calendar-controls/page.mdx",
      "section": "calendar",
      "headings": [
        "Calendar controls",
        "Install",
    ...
    },
    {
      ...
      "sourcePath": "website/app/docs/calendar/plugins/community-plugins/page.mdx",
      "section": "calendar",
      "headings": [
        "Community plugins",
        "List of plugins"
    ...
    },
    {
      ...
      "codeBlocks": [
        ...
        {
          "language": "js",
          "content": "import { createCurrentTimePlugin } from '@schedule-x/current-time'\n\nconst calendar = createCalendar({\n  /* other configuration */\n\n  plugins: [\n    createCurrentTimePlugin()\n  ]\n})"
        },
        {
          "language": "js",
          "content": "createCurrentTimePlugin({\n  // Whether the indicator should be displayed in the full width of the week. Defaults to false\n  fullWeekWidth: true,\n})"
        }
      ],
      "content": "Current time indicator This plugin adds a current time indicator to the calendar, according to the timezone of the calendar. This defaults to UTC if not configured otherwise. It will automatically update every minute. !Current time indicator Install Usage Configuration"
    },
    {
    ...
    },
    {
      ...
      "codeBlocks": [
        ...
        {
          "language": "js",
          "content": "import { createEventModalPlugin } from '@schedule-x/event-modal'\n\nconst eventModal = createEventModalPlugin()\n\nconst calendar = createCalendar({\n  // ...other configuration\n  plugins: [eventModal],\n})\n\neventModal.close(); // close the modal"
        },
        {
          "language": "tsx",
          "content": "import { useCalendarApp } from '@schedule-x/react'\nimport { createEventModalPlugin } from '@schedule-x/event-modal'\n\nconst customComponents = {\n  eventModal: ({ calendarEvent }) => {\n    return (\n      <div\n        style={{\n          padding: \"40px\",\n          background: \"yellow\",\n          color: \"black\",\n          borderRadius: \"24px\",\n          border: \"1px solid black\",\n          fontSize: \"24px\",\n          fontWeight: \"bold\",\n        }}\n      >\n        {calendarEvent.title}\n      </div>\n    );\n  },\n}\n\nfunction CalendarComponent() {\n  const calendar = useCalendarApp({\n    // ...other configuration\n\n    plugins: [createEventModalPlugin()],\n  })\n\n  return <>\n    <ScheduleXCalendar\n      customComponents={customComponents}\n      calendarApp={calendar}\n    />\n  </>\n}"
        }
      ],
      "content": "Event modal If your events have more information than just their time and a short title, chances are it would be helpful to display information about the events in a modal. Install Usage Methods close Close the modal programmatically. Customization If you're using one of the framework adapter components, like for React, you can customize modal content via passing customComponents prop like so:"
    },
    {
    ...
    },
    {
      ...
      "sourcePath": "website/app/docs/calendar/plugins/interactive-event-modal/page.mdx",
      "section": "calendar",
      "headings": [
    ...
    },
    {
      ...
      "codeBlocks": [
        ...
        {
          "language": "js",
          "content": "import { createResizePlugin } from '@sx-premium/resize'\n\nconst calendar = createCalendar({\n  /* other configuration */\n  plugins: [\n    createResizePlugin()\n  ],\n\n  callbacks: {\n    onEventUpdate(updatedEvent) {\n      console.log('onEventUpdate', updatedEvent)\n    },\n\n    // (Optionally) run your validation or side effects\n    // return false to stop the update, and true to allow it\n    onBeforeEventUpdate(oldEvent, newEvent, $app) {\n      return false\n    }\n  }\n})"
        },
        {
          "language": "js",
    ...
    },
    {
      ...
      "sourcePath": "website/app/docs/calendar/plugins/scheduling-assistant/page.mdx",
      "section": "calendar",
      "headings": [
      ...
      "codeBlocks": [
        {
          "language": "bash",
          "content": "npm install @sx-premium/scheduling-assistant @sx-premium/resource-scheduler @schedule-x/calendar\n@schedule-x/theme-default"
        },
        {
          "language": "js",
    ...
    },
    {
      ...
      "sourcePath": "website/app/docs/calendar/plugins/scroll-controller/page.mdx",
      "section": "calendar",
      "headings": [
        "Scroll controller",
        "Install",
      ...
      "codeBlocks": [
        ...
        {
          "language": "js",
          "content": "import { createScrollControllerPlugin } from '@schedule-x/scroll-controller'\n\nconst scrollController = createScrollControllerPlugin({\n  initialScroll: '07:50'\n})\n\nconst calendar = createCalendar({\n  /* other configuration */\n\n  plugins: [scrollController]\n})\ncalendar.render(document.getElementById('calendar'))\n\nscrollController.scrollTo('04:00')"
        }
      ],
      "content": "Scroll controller Take control over the scrolling in the week- and day view grids. Install Usage"
    },
    {
    ...
    },
    {
      ...
      "content": "Timezone select plugin The timezone select plugin adds a timezone select UI component to the calendar. Installation Usage"
    },
    {
      ...
      "codeBlocks": [
        {
          "language": "bash",
          "content": "npm install @sx-premium/resource-scheduler @schedule-x/calendar @schedule-x/translations @schedule-x/theme-default"
        },
        {
          "language": "js",
    ...
    },
    {
      ...
      "codeBlocks": [
        ...
        {
          "language": "tsx",
          "content": "import '@schedule-x/theme-shadcn/dist/index.css'\nimport { createCalendar } from '@schedule-x/calendar'\n\nconst calendar = createCalendar({\n  // ... other config,\n  theme: 'shadcn'\n})"
        },
        {
          "language": "css",
      ...
      "content": "💅 Theme You are not required to use any of the styles from the @schedule-x/theme-default package. If you are up for it, you can create your own theme from scratch, or just override rules of the default theme. If you do so, however, you might want to pin your schedule-x dependencies to a specific version, to avoid unexpected updates that might break your custom styles. Shadcn Theme For apps that are using Shadcn with its default design, you may want to use @schedule-x/theme-shadcn . Demo app Schedule-X is in no way affiliated with Shadcn, and this theme is not an official Shadcn software. It is merely a theme for Schedule-X that is designed to match with the Shadcn design. Customizing the default theme colors Schedule-X uses global CSS variables to define colors. Therefore, you can override the following CSS variables to customize the colors of the default theme:"
    },
    {
      ...
      "codeBlocks": [
        {
          "language": "bash",
          "content": "npm install @sx-premium/time-grid-resource-view @schedule-x/calendar @schedule-x/theme-default"
        },
        {
          "language": "js",
    ...
    },
    {
      ...
      "codeBlocks": [
        {
          "language": "bash",
          "content": "npm install @schedule-x/angular @schedule-x/calendar @schedule-x/theme-default"
        },
        {
          "language": "bash",
          "content": "pnpm install @schedule-x/angular @schedule-x/calendar @schedule-x/theme-default @preact/signals preact"
        },
        {
          "language": "bash",
          "content": "yarn add @schedule-x/angular @schedule-x/calendar @schedule-x/theme-default @preact/signals preact"
        },
        {
          "language": "ts",
    ...
    },
    {
      ...
      "codeBlocks": [
        {
          "language": "bash",
          "content": "npm install @schedule-x/svelte @schedule-x/calendar @schedule-x/theme-default temporal-polyfill"
        },
        {
          "language": "bash",
          "content": "pnpm install @schedule-x/svelte @schedule-x/calendar @schedule-x/theme-default @preact/signals preact temporal-polyfill"
        },
        {
          "language": "bash",
          "content": "yarn add @schedule-x/svelte @schedule-x/calendar @schedule-x/theme-default @preact/signals preact temporal-polyfill"
        },
        {
          "language": "svelte",
        ...
        {
          "language": "css",
          "content": ".sx-svelte-calendar-wrapper {\n  width: 1200px;\n  max-width: 100vw;\n  height: 800px;\n  max-height: 90vh;\n}"
        },
        {
          "language": "svelte",
          "content": "// TimeGridEvent.svelte\n<div>\n\t{calendarEvent.title}\n</div>\n\n<script lang=\"ts\">\n\texport let calendarEvent;\n</script>"
        },
        {
          "language": "svelte",
    ...
    },
    {
      ...
      "codeBlocks": [
        {
          "language": "bash",
          "content": "npm install @schedule-x/vue @schedule-x/calendar @schedule-x/theme-default temporal-polyfill"
        },
        {
          "language": "bash",
          "content": "pnpm install @schedule-x/vue @schedule-x/calendar @schedule-x/theme-default @preact/signals preact temporal-polyfill"
        },
        {
          "language": "bash",
          "content": "yarn add @schedule-x/vue @schedule-x/calendar @schedule-x/theme-default @preact/signals preact temporal-polyfill"
        },
        {
          "language": "vue",
        ...
        {
          "language": "css",
          "content": ".sx-vue-calendar-wrapper {\n  width: 1200px;\n  max-width: 100vw;\n  height: 800px;\n  max-height: 90vh;\n}"
        },
        {
          "language": "vue",
  ...
  "plugins": [
    ...
    },
    {
      ...
      "title": "Interactive event modal",
      "docsUrl": "https://schedule-x.dev/docs/calendar/plugins/interactive-event-modal",
      "description": "A plugin for displaying an interactive modal for adding, editing, viewing and removing events.",
      "isPremium": true
    },
    {
    ...
    },
    {
      ...
      "title": "Resource scheduler component",
      "docsUrl": "https://schedule-x.dev/docs/calendar/plugins/scheduling-assistant",
      "description": "Learn how to use the Schedule-X resource scheduler.",
      "isPremium": true
    },
    {
