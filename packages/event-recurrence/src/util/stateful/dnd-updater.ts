...
export class DndUpdater {
  ...
  update(eventId: EventId, oldEventStart: Temporal.ZonedDateTime | Temporal.PlainDate, newEventStart: Temporal.ZonedDateTime | Temporal.PlainDate) {
    ...
    const newDtStart = oldEventStart instanceof Temporal.ZonedDateTime
      ? addMinutesToTemporal(
          eventToUpdate.start,
          getDurationInMinutesTemporal(oldEventStart, newEventStart as Temporal.ZonedDateTime)
        )
