import { WeekWithDates } from '../../../../shared/src/types/time'
import { getDayNameShort } from '../../../../shared/src/utils/stateless/time/date-time-localization/date-time-localization'
import { useContext } from 'preact/compat'
import { AppContext } from '../../utils/stateful/app-context'
import { isToday } from '../../../../shared/src/utils/stateless/time/comparison'
