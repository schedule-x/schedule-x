...
describe('adding time', () => {
  it.each([
    ...
    [Temporal.ZonedDateTime.from('2000-01-01T00:00:00-05:00[America/New_York]'), 1, Temporal.ZonedDateTime.from('2000-02-01T00:00:00-05:00[America/New_York]')],
    [Temporal.ZonedDateTime.from('2000-01-01T00:00:00-05:00[America/New_York]'), 2, Temporal.ZonedDateTime.from('2000-03-01T00:00:00-05:00[America/New_York]')],
    [Temporal.ZonedDateTime.from('2000-01-01T00:00:00-05:00[America/New_York]'), 3, Temporal.ZonedDateTime.from('2000-04-01T00:00:00-05:00[America/New_York]')],
    [Temporal.ZonedDateTime.from('2000-01-01T00:00:00-05:00[America/New_York]'), 12, Temporal.ZonedDateTime.from('2001-01-01T00:00:00-05:00[America/New_York]')],
    [Temporal.ZonedDateTime.from('2000-01-01T00:00:00-05:00[America/New_York]'), -1, Temporal.ZonedDateTime.from('1999-12-01T00:00:00-05:00[America/New_York]')],
    [Temporal.ZonedDateTime.from('2000-01-01T00:00:00-05:00[America/New_York]'), -2, Temporal.ZonedDateTime.from('1999-11-01T00:00:00-05:00[America/New_York]')],
    [Temporal.ZonedDateTime.from('2000-01-01T00:00:00-05:00[America/New_York]'), -12, Temporal.ZonedDateTime.from('1999-01-01T00:00:00-05:00[America/New_York]')],
    [Temporal.ZonedDateTime.from('2000-01-01T00:00:00-05:00[America/New_York]'), 0, Temporal.ZonedDateTime.from('2000-01-01T00:00:00-05:00[America/New_York]')],
    [Temporal.PlainDate.from('2024-05-31'), 1, Temporal.PlainDate.from('2024-06-30')],
    [Temporal.PlainDate.from('2024-05-31'), 2, Temporal.PlainDate.from('2024-07-31')],
    [Temporal.PlainDate.from('2024-01-31'), 1, Temporal.PlainDate.from('2024-02-29')],
    [Temporal.PlainDate.from('2024-02-29'), -1, Temporal.PlainDate.from('2024-01-29')],
    [Temporal.PlainDate.from('2024-03-31'), -1, Temporal.PlainDate.from('2024-02-29')],
  ])(
