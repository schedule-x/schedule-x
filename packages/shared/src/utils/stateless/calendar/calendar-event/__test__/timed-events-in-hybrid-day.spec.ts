...
describe('CalendarEventImpl', () => {
  describe('the event time type in a hybrid day', () => {
    ...
    it.each([
      ...
      {
        start: Temporal.ZonedDateTime.from('2020-01-01T05:00:00+01:00[Europe/Berlin]'),
        end: Temporal.ZonedDateTime.from('2020-01-01T06:00:00+01:00[Europe/Berlin]'),
      },
      {
        start: Temporal.ZonedDateTime.from('2020-01-01T12:00:00+01:00[Europe/Berlin]'),
        end: Temporal.ZonedDateTime.from('2020-01-01T13:00:00+01:00[Europe/Berlin]'),
      },
    ])(
    ...
    it.each([
      {
        start: Temporal.ZonedDateTime.from('2020-01-01T23:00:00+01:00[Europe/Berlin]'),
        end: Temporal.ZonedDateTime.from('2020-01-02T01:00:00+01:00[Europe/Berlin]'),
      },
      {
        start: Temporal.ZonedDateTime.from('2020-01-01T23:59:00+01:00[Europe/Berlin]'),
        end: Temporal.ZonedDateTime.from('2020-01-02T00:00:00+01:00[Europe/Berlin]'),
      },
    ])(
    ...
    it.each([
      {
        start: Temporal.ZonedDateTime.from('2020-01-01T00:00:00+01:00[Europe/Berlin]'),
        end: Temporal.ZonedDateTime.from('2020-01-01T23:59:00+01:00[Europe/Berlin]'),
      },
      {
        start: Temporal.ZonedDateTime.from('2020-01-01T05:59:00+01:00[Europe/Berlin]'),
        end: Temporal.ZonedDateTime.from('2020-01-01T06:01:00+01:00[Europe/Berlin]'),
      },
      {
        start: Temporal.ZonedDateTime.from('2020-01-01T11:59:00+01:00[Europe/Berlin]'),
        end: Temporal.ZonedDateTime.from('2020-01-01T12:00:00+01:00[Europe/Berlin]'),
      },
    ])(
    ...
    it.each([
      {
        start: Temporal.ZonedDateTime.from('2020-01-01T23:00:00+01:00[Europe/Berlin]'),
        end: Temporal.ZonedDateTime.from('2020-01-03T01:00:00+01:00[Europe/Berlin]'),
      },
    ])(
