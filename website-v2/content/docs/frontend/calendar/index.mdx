...
<Cards num={2}>
  <Cards.Card
    arrow
    title="React"
    href="/docs/frontend/frameworks/react"
  ></Cards.Card>
  <Cards.Card
    arrow
    title="Vue"
    href="/docs/frontend/frameworks/vue"
  ></Cards.Card>
</Cards>
...
<Cards num={3}>
  <Cards.Card
    arrow
    title="Angular"
    href="/docs/frontend/frameworks/angular"
  ></Cards.Card>
  <Cards.Card
    arrow
    title="Svelte"
    href="/docs/frontend/frameworks/svelte"
  ></Cards.Card>
  <Cards.Card
    arrow
    title="Preact"
    href="/docs/frontend/frameworks/preact"
  ></Cards.Card>
</Cards>

## Coding with AI

If you use an AI coding agent, you can connect it to the [Schedule-X MCP server](/docs/frontend/ai/mcp). This lets your agent
search the docs, generate starter code and validate common Schedule-X setup details without you having to manually
go through the docs.
...
<Callout type="info">
  Curious about the `temporal-polyfill` package? Read more [here](/docs/frontend/calendar/temporal).
</Callout>
