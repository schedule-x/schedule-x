...
| `_options`                   | [See "_options" section](/docs/frontend/calendar/events/#_options) | Configuration for the event.                               | No       |
...
different date and time formats to Temporal, see the [Temporal](/docs/frontend/calendar/temporal#converting-different-date-and-time-formats-to-temporal) section.
...
If you want to get, update or remove events after rendering the calendar, you need to use the [events service plugin](/docs/frontend/calendar/plugins/events-service).
