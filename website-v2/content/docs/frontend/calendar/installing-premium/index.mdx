...
<Cards num={2}>
  <Cards.Card
    ...
    href="/docs/frontend/calendar/plugins/interactive-event-modal"
  ></Cards.Card>
  <Cards.Card
    arrow
    title="Drag-to-create plugin"
    href="/docs/frontend/calendar/plugins/drag-to-create"
  ></Cards.Card>
</Cards>
...
<Cards num={2}>
  <Cards.Card
    ...
    href="/docs/frontend/calendar/plugins/sidebar"
  ></Cards.Card>
  <Cards.Card
    arrow
    title="Resource view"
    href="/docs/frontend/calendar/resource-scheduler"
  ></Cards.Card>
</Cards>
