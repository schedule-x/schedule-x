...
For docs on how to use `rrule` and `exdate`, please see the [event recurrence documentation](/docs/frontend/calendar/plugins/recurrence).

## Update background events

See the [events service plugin](/docs/frontend/calendar/plugins/events-service) for how to update background events.
