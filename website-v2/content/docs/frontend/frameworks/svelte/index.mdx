...
The `createCalendar` function takes a [configuration object](/docs/frontend/calendar/configuration) as its single argument,
...
[Visual overview of all components](/docs/frontend/calendar/custom-components)
