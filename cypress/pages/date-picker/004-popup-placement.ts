...
createDatePicker({ placement: 'bottom-start' }, datePickerTopLeft as HTMLElement).bootstrap()
createDatePicker({ placement: 'bottom-end' }, datePickerTopRight as HTMLElement).bootstrap()
createDatePicker({ placement: 'top-start' }, datePickerBottomLeft as HTMLElement).bootstrap()
createDatePicker({ placement: 'top-end' }, datePickerBottomRight as HTMLElement).bootstrap()
